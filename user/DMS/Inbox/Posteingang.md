...
#### Scannen und archivieren
Hier haben Sie die Möglichkeit bei installiertem Scanner direkt in den Ordner Dokumente einzuscannen. Es öffnet sich das Scanfenster von <span style="color:hotpink;font-weight:bold">SIMPLIC</span>.
...
| An Benutzer senden | Hiermit kann das Dokument an einen anderen Benutzer in dessen Ablage (Nicht Posteingang) gelegt werden. Das Ablagesystem ist ein anderer Bereich von <span style="color:hotpink;font-weight:bold">SIMPLIC</span>. Es wird hierdurch nicht aus dem Posteingang entfernt! |
